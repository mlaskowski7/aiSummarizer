    ...
    <section className='mt-16 w-full max-w-xl'>
      <div className="flex flex-col w-full gap-2">
        <form className='relative flex justify-center items-center' onSubmit={handleSubmit}>
          ...
          <input type="url" placeholder="Enter a URL..." value={article.url} onChange={(event) => {
            setArticle({
              ...article,
          ...
          <button type="submit" className='submit_btn peer-focus:border-gray-700 peer-focus:text-gray-700 transition duration-300 ease-in-out'>
            Submit
          </button>
